...
Rnd12_50win <-readr::read_csv("50win_random12snpselection.csv",show_col_types = FALSE) 
...
# Select the desired Mids from Rnd12_50win
selected_Mids<- Rnd12_50win %>% dplyr::filter(grepl('Q313',Qid)) %>%
                                dplyr::pull(Mid) 
...
# Select the desired Mids from Rnd12_50win
selected_Mids<- Rnd12_50win %>% dplyr::filter(grepl('Q380',Qid)) %>%
  dplyr::pull(Mid) 
...
# Select the desired Mids from Rnd12_50win
selected_Mids<- Rnd12_50win %>% dplyr::filter(grepl('Q85',Qid)) %>%
  dplyr::pull(Mid) 
