...
awk '{print $1}' ../geno.train.gen9 > ID.gen9
awk '{$1=""}1' ../geno.train.gen9 > g1
sed -e "s/[ <tab>]*//g" g1 > g2
...
awk '{print $1}' ../geno.test.gen10 > ID.gen10
awk '{$1=""}1' ../geno.test.gen10 > g1
sed -e "s/[ <tab>]*//g" g1 > g2
...
awk 'NR>1' ../output_rep1/lm_mrk_001.txt |  awk '{print $1,$2,$3=sprintf("%10.0f",$3*1000000)}' > mapfile 
