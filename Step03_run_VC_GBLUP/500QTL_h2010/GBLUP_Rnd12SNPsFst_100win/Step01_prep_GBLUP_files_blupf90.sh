...
awk '{print $1}' ../Rnd12SNPsFst_${window}_$train > ID.$train
awk '{$1=""}1' ../Rnd12SNPsFst_${window}_$train > g1
sed -e "s/[ <tab>]*//g" g1 > g2
...
awk '{print $1}' ../Rnd12SNPsFst_${window}_$valid > ID.$valid
awk '{$1=""}1' ../Rnd12SNPsFst_${window}_$valid > g1
sed -e "s/[ <tab>]*//g" g1 > g2
...
awk '{print "M"$1}' ../Rnd12SNPsFst_$window  > mm2
